...
router.get('/dashboard/:formId', verifiedMiddleware, dashboard);
router.delete('/delete/:formId', verifiedMiddleware, deleteForm);
router.patch('/update/:formId', verifiedMiddleware, updateForm);
